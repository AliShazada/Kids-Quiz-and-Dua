...
public class page_dua_three extends Activity {

	private static int SPLASH_TIME_OUT1 = 13000;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		close=(ImageView)findViewById(R.id.close_btn3);
		
		

		stop = (ImageView) findViewById(R.id.stop3);
		next_but = (ImageView) findViewById(R.id.next_lay_one_but3);
...
//							.show();
		...
		next_but.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (counter >= 3) {
					Intent i = new Intent(page_dua_three.this,
							Level_cleared.class);
					managerOfSound_stop(click);
					startActivity(i);
		...
		close.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				new AlertDialog.Builder(page_dua_three.this)
				...
				.setPositiveButton("Yes",
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int id) {
								managerOfSound_stop(click);
								Intent i = new Intent(page_dua_three.this, MainMenu.class);
				                startActivity(i);	
							}
	...
	protected void managerOfSound(String theText) {
		...
		if (theText == "click") {
			mp = MediaPlayer.create(this, R.raw.dua_after_drinkingmilk);
			mp.start();
		}
